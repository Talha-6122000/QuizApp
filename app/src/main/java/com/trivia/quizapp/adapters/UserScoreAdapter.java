package com.trivia.quizapp.adapters;
...
import com.trivia.quizapp.R;
import com.trivia.quizapp.db.ScoreEntity;

public class UserScoreAdapter extends RecyclerView.Adapter<UserScoreAdapter.ScoreViewHolder> {

    List<ScoreEntity> scores;
    private Context context;

    public UserScoreAdapter(List<ScoreEntity> scores, Context context) {
        this.scores = scores;
